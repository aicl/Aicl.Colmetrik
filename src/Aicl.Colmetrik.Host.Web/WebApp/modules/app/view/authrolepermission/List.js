Ext.define('App.view.authrolepermission.List',{ 
    extend: 'Ext.grid.Panel',
    alias : 'widget.authrolepermissionlist', 
    constructor: function(config){
    	config= config|| {};
    	config.store= config.store|| 'AuthRolePermission',
	...
	{
		text: 'IdAuthPermission',
		dataIndex: 'IdAuthPermission',
		sortable: true,
		renderer: function(value, metadata, record, store){
           	if(value>=0){
            	return '<div class="x-cell-positive">'+Aicl.Util.formatInt(value)+'</div>';
